# ByteNews – Personalized News Browsing System 

A simple and user-friendly news browsing web application built using Python, Django, Bootstrap, and SQLite/PostgreSQL.
